      ...
      <div class="container mx-auto xl:px-32">
        <div class="grid lg:grid-cols-2 gap-12 flex items-center">
          <div class="mt-12 lg:mt-0">
            ...
            >
              The best introduction <br /><span class="text-blue-600"
                >for your portfolio</span
              >
            </h1>
            <p class="text-gray-600">
              Create you own portfolio with varieties of option. Showcase your
              creation with ease.
            </p>
          </div>
              ...
              <form>
                ...
                <div class="flex justify-center">
                  <a
                    href="#!"
                    role="button"
                    class="text-blue-600 hover:text-blue-700 focus:text-blue-700 action:text-blue-800 transition duration-200 ease-in-out"
                  >
                    <!-- Facebook -->
                    <svg
